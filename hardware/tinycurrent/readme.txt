TinyCurrent is based on the Arduino-Tiny cores with a custom boards.txt definition.
The attiny85 runs at 16 Mhz on the internal PLL with brown-out set to 2.7V for use
with 3.3V supply.  3.3V is useful if you are using .333V reference and/or 
interfacing with an ARM MCU.
